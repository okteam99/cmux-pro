...
final class FinderServicePathResolverTests: XCTestCase {
    ...
    func testOrderedUniqueDirectoriesUsesParentForFilesAndDedupes() {
        let input: [URL] = [
            URL(fileURLWithPath: "/tmp/cmuxpro-services/project", isDirectory: true),
            URL(fileURLWithPath: "/tmp/cmuxpro-services/project/README.md", isDirectory: false),
            URL(fileURLWithPath: "/tmp/cmuxpro-services/../cmux-services/project", isDirectory: true),
            URL(fileURLWithPath: "/tmp/cmuxpro-services/other", isDirectory: true),
        ]
        ...
        XCTAssertEqual(
            directories,
            [
                "/tmp/cmuxpro-services/project",
                "/tmp/cmuxpro-services/other",
            ]
        )
    }
    ...
    func testOrderedUniqueDirectoriesPreservesFirstSeenOrder() {
        let input: [URL] = [
            URL(fileURLWithPath: "/tmp/cmuxpro-services/b", isDirectory: true),
            URL(fileURLWithPath: "/tmp/cmuxpro-services/a/file.txt", isDirectory: false),
            URL(fileURLWithPath: "/tmp/cmuxpro-services/a", isDirectory: true),
            URL(fileURLWithPath: "/tmp/cmuxpro-services/b/file.txt", isDirectory: false),
        ]
        ...
        XCTAssertEqual(
            directories,
            [
                "/tmp/cmuxpro-services/b",
                "/tmp/cmuxpro-services/a",
            ]
        )
    }
