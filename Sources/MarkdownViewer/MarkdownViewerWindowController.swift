...
final class MarkdownViewerWindowController: NSWindowController, NSWindowDelegate, WKNavigationDelegate {
    ...
    private static func localizationStrings() -> [String: String] {
        [
            ...
            "markdownViewer.outline.title": String(localized: "markdownViewer.outline.title", defaultValue: "Outline"),
            "markdownViewer.outline.collapse": String(localized: "markdownViewer.outline.collapse", defaultValue: "Collapse outline"),
            "markdownViewer.outline.expand": String(localized: "markdownViewer.outline.expand", defaultValue: "Expand outline"),
        ]
    }
