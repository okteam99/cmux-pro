...
extension UNUserNotificationCenter {
    private static let removalQueue = DispatchQueue(
        label: "com.okteam99.cmuxpro.notification-removal",
        qos: .utility
    )
...
enum NotificationSoundSettings {
    ...
    private static let customSoundPreparationQueue = DispatchQueue(
        label: "com.okteam99.cmuxpro.notification-sound-preparation",
        qos: .utility
    )
    ...
    private static let customCommandQueue = DispatchQueue(
        label: "com.okteam99.cmuxpro.notification-custom-command",
        qos: .utility
    )
...
final class TerminalNotificationStore: ObservableObject {
    ...
    static let categoryIdentifier = "com.okteam99.cmuxpro.userNotification"
    static let actionShowIdentifier = "com.okteam99.cmuxpro.userNotification.show"
